...
### Construindo o Biga
Tomemos, por exemplo, a construção de [[Biga\|Biga]]. Cada atributo precisa que se rolem 4d6 e se somem os três melhores, assim ele teve: 
...
- Substituímos SAB -1 por 2 (15 = 4+5+6, 1), totalizando soma 9;
Finalmente, temos uma soma de atributos maior ou igual a 7.
Em seguida, escolhemos um atributo para aumentar. Neste caso, escolhemos CAR. Portanto, temos que os atributos são, em ordem, 1, 2, 0, 2, 4.

---
## Raça
Role 3d6 e veja a tabela abaixo.

| **3d6** | **Raças**                             |
| :-----: | ------------------------------------- |
|    3    | Escolha uma categoria... e não receba |
|    4    | Raça Rara                             |
|    5    | Raça Rara                             |
|    6    | Raça Extra                            |
|    7    | Raça Extra                            |
...
| **1d12** | **Raças**                                                 |
| -------- | --------------------------------------------------------- |
| 1        | Escolha uma raça - você não a recebe, role de novo        |
| 2        | Suraggel                                                  |
| 3        | Hynne                                                     |
| 4        | Trog                                                      |
| 5        | Osteon                                                    |
...
### Raça Rara
Role 2d6 ordenado (ou, se preferir, 1d6\*10 + 1d6) e determine sua raça na tabela abaixo.

| **2d6 ord.** | **Raça**                                            |
| ------------ | --------------------------------------------------- |
| 11           | Que Azar! Você vai ter uma Raça Comum mesmo...      |
| 12           | Centauro                                            |
| 13           | Elfo-do-Mar                                         |
| 14           | Harpia                                              |
| 15           | Voracis                                             |
